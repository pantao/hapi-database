...
var DB = function () {
  ...
  _createClass(DB, [{
    ...
    value: function loadModels(paths) {
      ...
      // 加载所有模型
      var models = _models2.default.applyRelations(_models2.default.load(files, this.sequelize.import.bind(this.sequelize)));
      ...
      for (var name in models) {
        ...
        var model = this.models[name] = models[name];
